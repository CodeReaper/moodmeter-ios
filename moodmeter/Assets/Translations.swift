...
struct Translations {
	...
	static let ALERT_DISMISS_CHANGES_MESSAGE = NSLocalizedString("ALERT_DISMISS_CHANGES_MESSAGE", comment: "")
	static let ALERT_DISMISS_CHANGES_TITLE = NSLocalizedString("ALERT_DISMISS_CHANGES_TITLE", comment: "")
	...
	static let EDITOR_SECTION_ANSWERS = NSLocalizedString("EDITOR_SECTION_ANSWERS", comment: "")
	static let EDITOR_SECTION_NAME = NSLocalizedString("EDITOR_SECTION_NAME", comment: "")
	static let EDITOR_SECTION_QUESTIONS = NSLocalizedString("EDITOR_SECTION_QUESTIONS", comment: "")
	static let EDITOR_TITLE = NSLocalizedString("EDITOR_TITLE", comment: "")
